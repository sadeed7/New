	...
	<!-- start: Header -->
		...
		<div class="row-fluid">
			...
			<div id="sidebar-left" class="span2">
				...
				<li class="active"><a href="<?php echo base_url(); ?>index.php/Employees/EmployeeCalendar"><i class="icon-edit"></i><span class="hidden-tablet">Schedule Calendar </span></a></li>
		...
		$('#calendar').fullCalendar({
			...
			events: [
               ...
               { 
                ...
                title: "'.$Calendar[$i]->FirstName.' '.$Calendar[$i]->LastName.'| Shift: '.$Calendar[$i]->shift.'",
