	...
	<!-- start: Header -->
		...
		<div class="row-fluid">
			...
			<div id="sidebar-left" class="span2">
				...
				<li class="active"><a href="<?php echo base_url(); ?>index.php/Employees/Employee_AddAvailability"><i class="icon-edit"></i><span class="hidden-tablet">Add Availability</span></a></li>
			...
			<ul class="breadcrumb">
				...
				<li>
					<i class="icon-edit"></i>
					<a href="<?php echo base_url(); ?>index.php/Employees/Employee_AddAvailability">Availability</a>
				</li>
			</ul>
			...
			<h2><i class="halflings-icon edit"></i><strong>Add Availability</strong></h2>
			</div>

					    <div class="box-content">
					   
            <br>
	<form class="form form-horizontal" id="employeeform" style="color: black;" method="post" 
	 action="<?php echo base_url(); ?>index.php/Employees/SaveAvailaibiltyData" >
						<fieldset>
						<?php
					...
					<div class="controls">
					<input type="date" class="input-xlarge focused"  name="From" data-date="" data-date-format="YYYY-MM-DD" placeholder="YYYY-MM-DD" required />
					</div>
					</div>
					...
					<!-- <h3 class="btn btn-primary">Rate</h3><br><br> -->
					<!-- <div class="control-group ">
					<label class="control-label" style="font-weight:bold;">Rate:</label>
					<div class="controls">
					<input class="input-xlarge focused"  name="Rate" type="text" placeholder="Enter Your Rate" required="">
					</div>
					</div> -->
					...
					<label class="span2"><input type="checkbox" name="night">&nbsp;Nightly</label>
						...
						<button type="submit" name="save" class="btn btn-primary">Save Availability</button>
