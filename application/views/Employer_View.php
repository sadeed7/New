...
<body>
	...
	<!-- start: Header -->
		...
		<div class="row-fluid">
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					...
					<br>
				<li class="active"><a href="<?php echo base_url(); ?>index.php/Employers"><i class="icon-edit"></i><span class="hidden-tablet">Profile </span></a></li>
		...
		<div class="modal-header"  style="background-color:#06A2CB;overflow:hidden;">
			...
			<h3 align="center" style="color:#FFF;">Change Your Email Or Password</h3>
		</div>
	...
	enctype="multipart/form-data" action="<?php echo base_url(); ?>index.php/Employers/SaveData" >
						<fieldset>
						<?php
					...
					<strong>'.$this->session->flashdata('Error').'</strong> 
						...
						rows="5" cols="50"  required="">Enter Your Address</textarea>
						</div>
						</div>
						<div class="row">
						<div class="control-group span6">
						<label class="control-label" style="font-weight:bold;">Choose Image:</label>
						<div class="controls">
